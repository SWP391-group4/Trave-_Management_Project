                    ...
                    <div>
                        ...
                        <div class="inner-form">
                            <div class="input-field">
                                <input type="text" value="" method="get" name="txt" class="form-control"  id="choices-text-preset-values" type="text" placeholder="How much discount you want to looking for ?" />
