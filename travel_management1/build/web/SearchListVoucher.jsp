        ...
        <body>
            <div style="margin-left: 120px">
                <div style="padding-bottom: 12px;margin-top: 30px ">
                    ...
                    <a href="#" style="color: #000">List Voucher with "${name}"</a>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="inner-form">
                            <div class="input-field">
                                <input type="text" value="${name}" method="get" name="name" class="form-control"  id="choices-text-preset-values" type="text" placeholder="Which voucher you want to looking for ?" />
