                                ...
                                <div class="col-lg-12 mb-4 col-md-6">
                                    ...
                                    <div class="card shadow mb-4" style="text-align: center">
                                        <div class="card-header py-3"  >
                                            <h6 class="m-0 font-weight-bold text-primary"> Update Voucher </h6>
                                        </div>                 
                                        ...
                                        <div class="container">
                                            <div class="login-box"  style="margin-top: 350px">
                                                <form  action="VoucherManager" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="user-box">
                                                        <input style="color:#000" type="text" name="title" required="" maxlength="50" value="${c.title}">
                                                        <label>Title</label>
                                                    </div>
                                                        <input type="hidden" name="VoucherId" value="${c.voucherId}">
                                                    <div class="user-box">
                                                        <input style="color:#000"type="text" name="description" required="" maxlength="500" value="${c.description}">
                                                        <label>Description</label>
                                                    </div>
                                                    <div class="user-box">
                                                        <input style="color:#000" type="number" name="discount" required="" min="0" max="100" value="${c.discount}">
                                                        <label>Discount</label>
                                                    </div>
                                                    <div class="user-box">
                                                        <input style="color:#000" type="number" name="quantity" required="" min="0" value="${c.quantity}">
                                                        <label>Quantity</label>
                                                    </div>
                                                    <div class="user-box">
                                                        <label>Image</label>
                                                    </div>
                                                       <img src="images/${c.image}" style="width: 90px ;height:102px ">
                                                    <br>
                                                    <br>
