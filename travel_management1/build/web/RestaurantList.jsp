                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 order-md-last" >
                        <div class="row">
                            ...
                            <c:set var="listMin" value="${listMin}"/>
                            <c:set var="listMax" value="${listMax}"/>
                                ...
                                <div class="col-sm col-md-6 col-lg-12 ftco-animate"style="border: 1px solid black; margin: 0 10px 20px 10px">
                                    <div class="destination" style="display: inline-flex">
                                        ...
                                        <div class="text p-3 col-lg-8">
                                            ...
                                            <span class="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                                </svg><i class="bi bi-person"> ${listMin.get(i)}-${listMax.get(i)} people/table</i></span>
                                            ...
                                            <p class="bottom-area d-flex">
                                                ...
                                                <span class="ml-auto"><i class="icon-map-o ml-auto" style="display: none">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${listAddress.get(i).getWard() == null}" >

                                                                ${listAddress.get(i).getSpecific()},${listAddress.get(i).getCity()}
                                                            </c:when>
                                                            <c:when test="${listAddress.get(i).getCity() == listAddress.get(i).getDistrict()}">
                                                                ${listAddress.get(i).getSpecific()},${listAddress.get(i).getCity()}
                                                            </c:when>
                                                            <c:otherwise>
                                                                ${listAddress.get(i).getSpecific()},${listAddress.get(i).getWard()},${listAddress.get(i).getCity()}
                                                            </c:otherwise>
                                                        </c:choose>
