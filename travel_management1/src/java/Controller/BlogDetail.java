...
public class BlogDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<Blogs> list3b = daob.viewtop3Blogses2(blogId);
            List<BlogDetails> listbd = daobd.viewBlogsDetail(blogId);
            List<Marketing> listm = dao.getAuthorMarketings(blogId+"    ");
            String title=daob.getTitle(blogId);
