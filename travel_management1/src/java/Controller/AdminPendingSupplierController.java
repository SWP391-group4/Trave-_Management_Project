...
public class AdminPendingSupplierController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Suppliers supplier = daoSup.getSupplierById(supplierId);
        SupplierAddresses supAddress= daoSup.getSupplierAddress(supplierId);
        SupplierImage supImage = daoSup.getSupplierImage(supplierId);
        
        request.setAttribute("supplier", supplier);
        request.setAttribute("supAddress", supAddress);
        request.setAttribute("supImage", supImage);
        request.getRequestDispatcher("PendingSupplier.jsp").forward(request, response);
    }
