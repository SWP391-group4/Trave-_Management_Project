...
//     */
    ...
    public void testUpdateHomeStayDetail() {
     ...
     @Test
    public void testUpdateHomeStayDetailUT2() {
        System.out.println("updateHomeStayDetail");
        HomeStayDetails hd = new HomeStayDetails("HS0001", 1, 2, 3, 4, 5, "11:30:00.0000000", "11:30:00.0000000",30000, "jdksaldk", 0, "dsaidjsaoid");
        DAOHomeStays instance = new DAOHomeStays();
        int expResult = 1;
        int result = instance.updateHomeStayDetail(hd);
        assertEquals(expResult, result);
    ...
    @Test
    public void testUpdateHomeStayDetailUT3() {
        System.out.println("updateHomeStayDetail");
        HomeStayDetails hd = new HomeStayDetails("HS000070", 1, 2, 3, 4, 5, "11:30:00.0000000", "11:30:00.0000000",30000, "jdksaldk", 0, "dsaidjsaoid");
        DAOHomeStays instance = new DAOHomeStays();
        int expResult = 0;
        int result = instance.updateHomeStayDetail(hd);
        assertEquals(expResult, result);
